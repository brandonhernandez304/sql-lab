...
-- Write SQL query here
SELECT * FROM countrylanguage WHERE language='Italian' ORDER BY language DESC;
-- SMR has 100% Italian spoken
...
-- Write SQL query here
SELECT * FROM city WHERE name LIKE 'Serr%' and countrycode <> 'SMR';
